...
export interface JwtAuthConfig {
    ...
    /**
     * The Client ID stored in config on the backend
     */
    clientId: string;
    ...
    /**
     * Will cache token in Local Storage if set to try, else it will cache in memory.
     */
    useLocalStorage?: boolean;

    /**
     * Configuration for the patient http interceptor, used for
...
export const AuthConfigService = new InjectionToken<JwtAuthConfig>(
    'filelink-auth.config'
);
