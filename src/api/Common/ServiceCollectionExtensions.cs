...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddJwtAuth(this IServiceCollection services, IConfiguration config, IWebHostEnvironment env)
    {
        ...
        if (string.IsNullOrEmpty(jwtAuth.SecurityKey))
        {
            ...
            var keyPath = Path.Combine(env.ContentRootPath, "jwtkey.txt");
    ...
    public static IServiceCollection AddOmdbPlugin(this IServiceCollection services, IConfiguration config)
    {
        var omdbSettings = config.GetSection("OmdbSettings").Get<OmdbSettings>();
        if (omdbSettings is not null)
        {
