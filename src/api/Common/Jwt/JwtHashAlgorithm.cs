...
public static class JwtClaimTypes
{
    ...
    public const string AvatarId = "https://sign5g.com/avatar_id";
    public const string TenantId = "https://sign5g.com/tenant_id";
    public const string PersonId = "https://sign5g.com/app_user_id";
